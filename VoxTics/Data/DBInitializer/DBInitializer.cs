...
namespace ECommerce516.Utitlity.DBInitializer
{
    public class DBInitializer : IDBInitializer
    {
        ...
        public DBInitializer(MovieDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
