...

{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Register(Models.ViewModels.RegisterVM registerVM)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Login(Models.ViewModels.LoginVM loginVM)
        {
            if(!ModelState.IsValid)
            {
                return View(loginVM);
